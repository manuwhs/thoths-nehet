...
from .parsers import oxford_parser
...
class OxfordCrawler(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs): 
      super(OxfordCrawler, self).__init__(*args, **kwargs) 
      words = kwargs.get('words').split(",")
      self.start_urls= ["https://www.lexico.com/en/definition/" + word for word in words]
    ...
    def parse(self, response):
        ...
        definition_dict = oxford_parser(response)
        if definition_dict:
